                ...
                <Grid container sx={{ alignItems: 'center' }}>
                  ...
                  <Grid item xs={12} sm={4}>
                    <Box
                      ...
                      <Link
                        href={`https://twitter.com/${entities?.twitter_username}`}
                        color="inherit"
                        sx={{ display: 'flex', alignItems: 'center', width: '30px' }}>
                        <TwitterIcon color="primary">add_circle</TwitterIcon>
                      </Link>
                      <Link
                        href={`mailto:${entities?.email}`}
                        color="inherit"
                        sx={{ display: 'flex', alignItems: 'center', width: '30px' }}>
                        <EmailIcon color="primary">add_circle</EmailIcon>
                      </Link>
                      <Link
                        href={`https://${entities?.blog}`}
                        color="inherit"
                        sx={{ display: 'flex', alignItems: 'center', width: '30px' }}>
                        <LinkIcon color="primary">add_circle</LinkIcon>
                      </Link>
                    </Box>
                  </Grid>
                </Grid>
